...
// The implementation is wrong and needs to be corrected
...
int main()
{
    ...
    construct_a_binary_tree(ROOT);

    insert_in_a_binary_tree(ROOT,80);
    insert_in_a_binary_tree(ROOT,90);
    insert_in_a_binary_tree(ROOT,100);

    cout << "pre-order traversal of the new tree is ";
